        ...
        <div class="col-lg-12">
          ...
          <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
            <h3>안녕하세요! HTP검사를 시작해볼까요?</h3>
             ...
             프리셋으로 검사하기 <input type="checkbox" id="drawCheckbox" style="margin-left: 10px; margin-top: 30px;">
            
            <div style="margin-top: 10px;">
    		<button id="startButton" style="background-color: skyblue; border: none; color: white; padding: 10px 150px; border-radius: 5px; cursor: pointer; margin-top: 15px;">시작하기</button>
			</div>
                          ...
                          <div class="row">
                            <div class="col-lg-6 align-self-center">
                              <div class="left-text">
                                ...
                                <div class="ticks-list"><p><i class="fa fa-check"></i> 파일 업로드</p>    
                                <p><i class="fa fa-check"></i> 직접 그리기</p>
                                
                                 <br>
                                 <span><i class="fa fa-check"></i> 프리셋</span>
                                  
                                <p>프리셋을 이용하는 방법으로 검사가 이루어집니다.</p>
                              </div>
                            </div>
                            <div class="col-lg-6 align-self-center">
                              <div class="right-image">
                                <img src="${cpath}/resources/images/preset.png" alt="">
                              </div>
                            </div>
                          </div>
                        </div>
