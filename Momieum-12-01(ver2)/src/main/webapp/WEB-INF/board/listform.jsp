                ...
                <div class="card-body">
                   ...
                   <form action="${cpath}/register" method="post">
                      ...
                      <div class="form-grovup">
                         ...
                         <textarea id="content" name="content" class="form-control" placeholder="내용을 입력해 주세요" rows="8" cols=""></textarea> <!--높이rows 가로cols-->                 
                      </div>
                      
                     
                      <div class="form-group"> <!--시작 첨부파일 -->
	                ...
	                <div class="input-group">
                      ...
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="writer" name="writer" placeholder="작성자를 입력해 주세요">
                      </div>
                      
                      
                      <div>
                      	<button type ="submit" class="btn btn btn-secondary">등록</button>
                      	<button type ="reset" class="btn btn btn-secondary">작성취소</button>	
                      	<a href="list" class = "btn btn btn-secondary">목록</a>	
                      </div>
