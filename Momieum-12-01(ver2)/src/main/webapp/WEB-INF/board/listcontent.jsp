                ...
                <div class="card-body">
                   ...
                   <form action="${cpath}/register" method="post">
                      ...
                      <div class="form-group">
                         ...
                         <td><input value="${vo.title}" type="text" name="title" class="form-control" readonly> </td>
                      </div>
                      
                      
                      <div class="form-grovup">
                         <label for="content">내용</label>
                         <td><textarea class="form-control" name="content" rows="7" cols="" readonly>${fn:replace(vo.content, newLineChar, "<br/>" )}</textarea></td>               
                      </div>
                      ...
                      <div class="form-group">
                         ...
                         <td><input value="${fn:split(vo.indate," ")[0]}" type="text" name="indate" class="form-control" readonly></td> 
                      </div>
                      
                      
                      <div>
                      	<a href="../listupdateform/${vo.idx}" class = "btn btn-secondary">수정화면</a>
   	
                      	<a href="../remove/${vo.idx}" class = "btn btn-secondary ">삭제</a>
