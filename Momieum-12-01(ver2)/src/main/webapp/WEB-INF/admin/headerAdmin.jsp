...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
           <a href="${cpath}/index2.do" class="nav-link">홈페이지 바로가기</a>
      </li>
    </ul>
        ...
        <div class="navbar-search-block">
          <form class="form-inline">
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" placeholder="검색하세요" aria-label="Search">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="${cpath}/admin/adminMain.do" class="brand-link">
      <img src="${cpath}/resources/images/tree123.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="${cpath}/resources/images/zzanggu71.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><%= userDetails.getUsername() %></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="${cpath}/admin/dashBoard.do" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="${cpath}/admin/boardMemberList" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>회원목록</p>
                </a>
              </li>
          ...
          <li class="nav-item">
                <a href="${cpath}/admin/tbBoardAdminList" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>심리검사결과</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="${cpath}/admin/applyAdmin" class="nav-link">
