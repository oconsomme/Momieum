            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                   <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">회원정보수정</a></li>
                   <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">자녀정보수정</a></li>
                   <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">심리테스트결과</a></li>
                </ul>
           </div><!-- /.card-header -->
